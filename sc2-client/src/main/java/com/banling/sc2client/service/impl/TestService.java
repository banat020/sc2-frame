package com.banling.sc2client.service.impl;
...
public class TestService implements ITestService {
	...
	public String getMsg(String msg) {
		...
		params.put("msg", msg);
		return restTemplate.getForObject("http://sc2-service/sc2-service/hello/getMsg?msg={msg}", String.class,params);
	}
	...
	public List<User> getUserList(Integer count) {
		...
		return restTemplate.getForObject("http://sc2-service/sc2-service/hello/userList/{count}",List.class,params);
	}
	...
	public Collection<String> getServerMetadata() {
		// TODO Auto-generated method stub
		// 获得调用服务的信息,并打印出来
		ServiceInstance serviceInstance = this.loadBalancerClient.choose("sc2-service");
	...
	public String noRestApi() {
		// TODO Auto-generated method stub
		return restTemplate.getForObject("http://sc2-service/sc2-service/welcome", String.class);
	}
